...
WEB_APP_NAME=$(azd env get-values | grep -q "WEB_APP_NAME" && azd env get-value WEB_APP_NAME)
RESOURCE_GROUP_NAME=$(azd env get-values | grep -q "RESOURCE_GROUP_NAME" && azd env get-value RESOURCE_GROUP_NAME)
